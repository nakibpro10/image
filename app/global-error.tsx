        ...
        <main className="min-h-screen flex items-center justify-center px-6 relative overflow-hidden bg-background">
          ...
          <div className="relative z-10 w-full max-w-xl">
            <div className="glass-panel rounded-3xl p-8 md:p-10 text-center">
              ...
              <p className="text-sm font-semibold uppercase tracking-[0.3em] text-destructive/80">Critical Error</p>
              <h1 className="mt-3 text-3xl md:text-4xl font-bold text-foreground">CloudPix could not load</h1>
              <p className="mx-auto mt-4 max-w-md text-sm md:text-base leading-relaxed text-muted-foreground">
                A fatal rendering error occurred before the normal app shell finished loading.
              </p>
